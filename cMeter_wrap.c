...
SWIGINTERN PyObject *_wrap_setTargetArray(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!SWIG_Python_UnpackTuple(args, "setTargetArray", 3, 3, swig_obj)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "setTargetArray" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  ecode4 = SWIG_AsVal_int(swig_obj[2], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "setTargetArray" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  setTargetArray(arg1,arg2,arg3,arg4);
  resultobj = SWIG_Py_Void();
  {
...
SWIGINTERN PyObject *_wrap_setDigit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "setDigit" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  setDigit(arg1);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_setDigitCol(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "setDigitCol", 2, 2, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "setTargetArray", _wrap_setTargetArray, METH_VARARGS, NULL},
	 ...
	 { "setDigit", _wrap_setDigit, METH_O, NULL},
	 { "setDigitCol", _wrap_setDigitCol, METH_VARARGS, NULL},
	 { "setSegRows", _wrap_setSegRows, METH_O, NULL},
