...
def setTargetArray(array, w, h):
    return _cMeter.setTargetArray(array, w, h)
...
def setDigit(index):
    return _cMeter.setDigit(index)

def setDigitCol(strCol, endCol):
    return _cMeter.setDigitCol(strCol, endCol)

def setSegRows(segRows):
    return _cMeter.setSegRows(segRows)
